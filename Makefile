...
OBJECTS=$(OBJ_DIR)/main.o $(OBJ_DIR)/Block.o $(OBJ_DIR)/Button.o $(OBJ_DIR)/Config.o $(OBJ_DIR)/Editor.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/Game.o $(OBJ_DIR)/Hitbox.o $(OBJ_DIR)/Map.o $(OBJ_DIR)/Menu.o $(OBJ_DIR)/Object.o $(OBJ_DIR)/PauseMenu.o $(OBJ_DIR)/Player.o $(OBJ_DIR)/Projectile.o $(OBJ_DIR)/ResourceManager.o $(OBJ_DIR)/Vehicle.o
#header files that src files are dependant on
DEPS=$(HDR_DIR)/AI.h $(HDR_DIR)/Block.h $(HDR_DIR)/Button.h $(HDR_DIR)/Config.h $(HDR_DIR)/Editor.h $(HDR_DIR)/Engine.h $(HDR_DIR)/Game.h $(HDR_DIR)/Hitbox.h $(HDR_DIR)/Map.h $(HDR_DIR)/Menu.h $(HDR_DIR)/Object.h $(HDR_DIR)/PauseMenu.h $(HDR_DIR)/Player.h $(HDR_DIR)/Projectile.h $(HDR_DIR)/ResourceManager.h $(HDR_DIR)/Vehicle.h
